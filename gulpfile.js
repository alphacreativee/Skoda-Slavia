...
// function fontCss() {
//   return src("assets/font/**/*.css", { allowEmpty: true }) // Lấy tất cả file .css trong tất cả thư mục con của assets/font/
//     .pipe(plumber()) // Ngăn task dừng khi có lỗi
//     .pipe(cleanCSS()) // Nén file CSS
//     .pipe(rename({ suffix: ".min" })) // Thêm hậu tố .min
//     .pipe(dest("assets/main/font")) // Xuất file đã nén vào assets/main/css
//     .pipe(browserSync.stream()); // Reload trình duyệt
// }
